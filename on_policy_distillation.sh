...
export TRAIN_DATASET=datasets/test_data/MATH/train.parquet
...
TEST_DATASET=${TEST_FILE:-["$TEST_DATA_DIR/MATH-500/test.parquet", "$TEST_DATA_DIR/AMC23/test.parquet", "$TEST_DATA_DIR/Minerva/test.parquet", "$TEST_DATA_DIR/Olympiad-Bench/test.parquet", "$TEST_DATA_DIR/AIME24/test.parquet", "$TEST_DATA_DIR/AIME25/test.parquet"]}
...
# TODO:
export ACTOR_MODEL_PATH=model/Qwen3-0.6B-Base
...
export REWARD_MODEL_PATH=model/Qwen3-8B-Base
