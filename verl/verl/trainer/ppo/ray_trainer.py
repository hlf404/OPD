                ...
                with marked_timer("step", timing_raw):
                    ...
                    with marked_timer("reward", timing_raw, color="yellow"):
                        ...
                        if self.use_rm and "rm_scores" not in batch.batch.keys():
                            ...
                            reverse_top_k = self.config.actor_rollout_ref.rollout.get("reverse_kl_top_k", 0)
                            forward_top_k = self.config.actor_rollout_ref.rollout.get("forward_kl_top_k", 0)
                            ...
                            batch.meta_info["reverse_kl_top_k"] = reverse_top_k
                            batch.meta_info["forward_kl_top_k"] = forward_top_k
                    ...
                    with marked_timer("adv", timing_raw, color="brown"):
                        ...
                        if "overlap_mask" in batch.batch.keys() and "advantages" in batch.batch.keys():
                            try:
                                ...
                                top_k = batch.meta_info.get("reverse_kl_top_k", 0)
